import{i as o}from"./init-i4ctr-NL.js";const a=[{id:"1",title:"Amaze",description:"On Platform Knowledge Management Solution for ServiceNow, featuring a drag-and-drop article builder, customizable templates, and an intuitive interface to streamline content creation and management.",technologies:["Vue","Vuetify","Grapesjs","ServiceNow"],image:"/assets/images/amaze_logo.svg",liveUrl:"https://intellective.co/amaze-knowledge-builder-for-servicenow",githubUrl:"https://github.com/yourusername/ecommerce",status:"featured",date:"2024-01"},{id:"2",title:"DM's Friend",description:"Open source tool for Dungeons & Dragons players to enchance remote play by sharing collaborative virtual table tops, character sheets, and campaign management features.",technologies:["Redis","PostgreSQL","Node.js","Express","Socket.io"],image:"/assets/images/DMF_icon.png",liveUrl:"https://example.com",githubUrl:"https://github.com/yourusername/task-app",status:"coming-soon",date:"2023-11"},{id:"3",title:"JSON Util on Servicenow",description:"A utility created after teams shared frustration manipulating coplex json structures in servicenow string fields, such as system_properties and custom table fields.",technologies:["JavaScript","ServiceNow","JSON"],image:"/assets/images/jsnow_logo.png",date:"2023-09"}];o(l);function l(){if(!a||a.length===0)return;const r=a,i=document.getElementById("projects-container");i.innerHTML="",r.forEach((e,n)=>{const t=document.createElement("article");t.className="card group",t.dataset.animate="true",t.dataset.animation="fadeIn",n<5&&t.style.setProperty("--animate-delay",`${n*100}ms`),t.innerHTML=`
